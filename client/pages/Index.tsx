          ...
          <nav className="px-3 py-3 flex-1">
            <div className="space-y-1.5">
              ...
              <button className="w-full h-[42px] flex items-center gap-1.5 px-2.5 rounded text-text-secondary hover:bg-white/50 transition-colors">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path
                    d="M1.5 3C1.5 2.58579 1.83579 2.25 2.25 2.25H10.5V3.75H3V14.25H15V8.25H16.5V15C16.5 15.4142 16.1642 15.75 15.75 15.75H2.25C1.83579 15.75 1.5 15.4142 1.5 15V3ZM5.25 9.75H6.75V12.75H5.25V9.75ZM8.25 5.25H9.75V12.75H8.25V5.25ZM11.25 7.5H12.75V12.75H11.25V7.5Z"
                    fill="#45556C"
                  />
                </svg>
              ...
              <button className="w-full h-[42px] flex items-center gap-1.5 px-2.5 rounded text-text-secondary hover:bg-white/50 transition-colors">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  <path
                    d="M2.25 2.25H15.75C16.1642 2.25 16.5 2.58579 16.5 3V15C16.5 15.4142 16.1642 15.75 15.75 15.75H2.25C1.83579 15.75 1.5 15.4142 1.5 15V3C1.5 2.58579 1.83579 2.25 2.25 2.25ZM15 5.42844L9.05385 10.7535L3 5.41195V14.25H15V5.42844ZM3.38359 3.75L9.04642 8.7465L14.6257 3.75H3.38359Z"
                    fill="#45556C"
                  />
                </svg>
              ...
              <div className="flex items-center gap-2.5 px-1.5">
                <div className="w-8 h-8 rounded-full border border-neutral-border bg-white flex items-center justify-center flex-shrink-0">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path
                      d="M16.6668 18.3333H15.0002V16.6666C15.0002 15.2859 13.8809 14.1666 12.5002 14.1666H7.50016C6.11945 14.1666 5.00016 15.2859 5.00016 16.6666V18.3333H3.3335V16.6666C3.3335 14.3655 5.19898 12.5 7.50016 12.5H12.5002C14.8013 12.5 16.6668 14.3655 16.6668 16.6666V18.3333ZM10.0002 10.8333C7.23874 10.8333 5.00016 8.59473 5.00016 5.83331C5.00016 3.07189 7.23874 0.833313 10.0002 0.833313C12.7616 0.833313 15.0002 3.07189 15.0002 5.83331C15.0002 8.59473 12.7616 10.8333 10.0002 10.8333ZM10.0002 9.16665C11.8411 9.16665 13.3335 7.67426 13.3335 5.83331C13.3335 3.99236 11.8411 2.49998 10.0002 2.49998C8.15921 2.49998 6.66683 3.99236 6.66683 5.83331C6.66683 7.67426 8.15921 9.16665 10.0002 9.16665Z"
                      fill="#1D293D"
                    />
                  </svg>
                </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 md:px-6 py-8 md:py-12 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full max-w-[804px] flex flex-col items-center space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-center justify-between">
                  <button className="w-8 h-8 flex items-center justify-center rounded border border-neutral-border hover:bg-neutral-50 transition-colors">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                      <path
                        d="M11.1215 5.81803L6.87885 10.0607C6.58595 10.3535 6.58595 10.8284 6.87885 11.1213C7.17174 11.4143 7.64662 11.4143 7.9395 11.1213L12.1822 6.87869C13.0608 6.00001 13.0608 4.5754 12.1822 3.69671C11.3035 2.81803 9.87885 2.81803 9.00015 3.69671L4.75753 7.93936C3.29306 9.40381 3.29306 11.7782 4.75753 13.2427C6.22199 14.7071 8.59635 14.7071 10.0608 13.2427L14.3035 9.00001L15.3641 10.0607L11.1215 14.3033C9.07125 16.3535 5.74712 16.3535 3.69687 14.3033C1.64662 12.2531 1.64662 8.92898 3.69687 6.87869L7.9395 2.63605C9.40395 1.17159 11.7784 1.17159 13.2428 2.63605C14.7073 4.10052 14.7073 6.47488 13.2428 7.93936L9.00015 12.182C8.12152 13.0607 6.69687 13.0607 5.81819 12.182C4.93951 11.3033 4.93951 9.87871 5.81819 9.00001L10.0608 4.75738L11.1215 5.81803Z"
                        fill="#1D293D"
                      />
                    </svg>
                  </button>
                  <button className="w-8 h-8 flex items-center justify-center rounded bg-primary hover:bg-primary/90 transition-colors">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                      <path
                        d="M9.75014 5.87132V15H8.25014V5.87132L4.22717 9.8943L3.1665 8.83365L9.00014 3L14.8338 8.83365L13.7731 9.8943L9.75014 5.87132Z"
                        fill="white"
                      />
                    </svg>
                  </button>
            ...
            <div className="w-full max-w-[768px] grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-x-2 md:gap-y-4">
              ...
              />
              <ActionCard icon={<AIIcon />} label="오늘 일정 알려줘" />
              <ActionCard icon={<AIIcon />} label="오늘 근로 시간 등록해줘" />
              <ActionCard icon={<PlusIcon />} label="빠른 작업 추가" isAdd />
            </div>
          </div>
        </div>
      </main>
...
function ActionCard({
  ...
  return (
    <button
      className={`h-[72px] flex items-center gap-3.5 px-3.5 rounded-lg border border-neutral-border bg-white shadow-[0_1px_2px_0_rgba(50,56,62,0.08)] hover:shadow-[0_2px_4px_0_rgba(50,56,62,0.12)] transition-all ${isAdd ? "cursor-pointer" : ""}`}
    >
      <div
        className={`w-9 h-9 flex items-center justify-center rounded flex-shrink-0 ${isAdd ? "" : "bg-primary-50 p-1.5"}`}
      >
        {icon}
      </div>
      <span
        className={`text-sm font-bold leading-[142%] text-left ${isAdd ? "text-text-tertiary" : "text-text-primary"}`}
      >
        {label}
      </span>
    </button>
...
function PlusIcon() {
  return (
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
      <path
        d="M11.9165 11.9167V5.41666H14.0832V11.9167H20.5832V14.0833H14.0832V20.5833H11.9165V14.0833H5.4165V11.9167H11.9165Z"
        fill="#45556C"
      />
    </svg>
  );
